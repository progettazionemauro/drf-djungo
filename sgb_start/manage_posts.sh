...
# Calcolo dinamico della directory dello script
SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"

# Path relativi calcolati dinamicamente
LOG_FILE="$SCRIPT_DIR/../manage_posts.log"
POSTS_DIR="$SCRIPT_DIR/content/contenuti"
