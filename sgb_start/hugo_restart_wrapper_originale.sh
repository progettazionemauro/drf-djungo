...
start_hugo() {
  echo "Starting Hugo server with live reload..." >> "$LOG_FILE"
...
# Attendi 2 secondi
echo "Waiting for 2 seconds before stopping Hugo..." >> "$LOG_FILE"
sleep 2
...
# Attendi 1 secondo
echo "Waiting for 1 second before restarting Hugo..." >> "$LOG_FILE"
sleep 1
