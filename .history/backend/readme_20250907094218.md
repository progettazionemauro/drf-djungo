...
## Heading1) Preparazione server (una volta sola)
...
## Heading2) Struttura cartelle (nuovo “green”)
...
## Heading3) Trasferimento progetto (scegline uno)
...
## Heading4) Virtualenv + dipendenze
...
## Heading5) Variabili d’ambiente (separate!)
...
## Heading6) Migrazioni + statici (prima accensione)
