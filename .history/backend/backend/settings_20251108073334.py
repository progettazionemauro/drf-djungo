...
# === CORS ===
# DEV: puoi consentire tutte le origini mettendo in .env.dev -> CORS_ALLOW_ALL=true
# PROD: specifica una lista di origini sicure in .env.prod -> CORS_ALLOWED_ORIGINS=https://site1,https://site2
if os.getenv("CORS_ALLOW_ALL", "0").strip().lower() in ("1", "true", "yes"):
    CORS_ALLOW_ALL_ORIGINS = True
else:
    CORS_ALLOWED_ORIGINS = [
        o.strip() for o in os.getenv(
            "CORS_ALLOWED_ORIGINS",
            # default “comodo” per dev locale con porte che cambiano
